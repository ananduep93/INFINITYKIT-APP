...
class ToolNavigation {
  ...
  static Widget? _getNativeScreen(String toolId) {
    switch (toolId) {
      ...
      case 'discountcalc': return const DiscountCalculatorScreen();
      case 'expenseadd': return const AddExpenseScreen();
      case 'expenselist': return const ExpenseListScreen();
      case 'percentagecalc': return const PercentageCalculatorScreen();
      case 'primenumber': return const PrimeCheckerScreen();
      case 'palindrome': return const PalindromeCheckerScreen();
      case 'randomnamepicker': return const NamePickerScreen();
      case 'factorial': return const FactorialCalculatorScreen();
      case 'yesnogerator': return const YesNoGeneratorScreen();
      case 'averagecalculator': return const AverageCalculatorScreen();
      case 'fibonacci': return const FibonacciGeneratorScreen();
      case 'lcmhcf': return const LcmHcfCalculatorScreen();
      case 'trianglechecker': return const TriangleCheckerScreen();
      case 'daysbetween': return const DaysBetweenDatesScreen();
      case 'examcalc': return const ExamMarksCalculatorScreen();
      case 'numbersorter': return const NumberSorterScreen();
      case 'passwordstrength': return const PasswordStrengthScreen();
      case 'choicecomparator': return const ChoiceComparatorScreen();
      case 'drugdosage': return const DrugDosageScreen();
      case 'ivdripcalc': return const IvDripRateScreen();
      case 'spinwheel': return const SpinWheelScreen();
      case 'urlencoder': return const UrlEncoderDecoderScreen();
      ...
      case 'distancecalc': return const DistanceCalculatorScreen();
      case 'equationsolver': return const EquationSolverScreen();
      case 'graphmaker': return const GraphMakerScreen();
      case 'medicinereminder': return const MedicineReminderScreen();
      case 'chatbot': return const AiChatbotScreen();
      case 'text-improver': return const AiTextToolsScreen(title: 'AI Text Improver', hint: 'Enter text to improve...', type: 'improve');
      ...
      case 'image-generator': return const AiImageGeneratorScreen();
      case 'calendarviewer': return const CalendarViewerScreen();
      ...
      case 'imagetopdf': return const ImageToPdfScreen();
      case 'pdftoimage': return const PdfToImageScreen();
      case 'mergepdf': return const MergePdfScreen();
      case 'rotatepdf': return const RotatePdfScreen();
      case 'compressimage': return const CompressImageScreen();
      case 'imageinfo': return const ImageInfoScreen();
      ...
      case 'reminderalert': return const ReminderAlertScreen();
      ...
      case 'urlextractor': return const UrlParamExtractorScreen();
      case 'metatagviewer': return const MetaTagViewerScreen();
